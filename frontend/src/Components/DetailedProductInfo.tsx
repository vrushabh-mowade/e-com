    ...
    <div>
      <div className="w-80  bg-white">
                <div className="flex flex-col items-center justify-center ">
                  <div className="font-light text-lg text-yellow-600">{productDetails.manufacturer}</div>
                  <div className="font-normal text-md not-italic text-zinc-600">
                  {productDetails.title}
                  </div>
                  <div className="flex items-center justify-center p-4 gap-2">
                    <RatingTag rate={productDetails.rating} />
                    <span className="proportional-nums text-zinc-600 text-sm">315 Rating</span>
                  </div>
                  ...
                  <div id="discountdetils" className="flex">
                    <div id=""></div>
                    <div id="" className="text-xs text-zinc-600 ">price inclusive of all taxes</div>
                  </div>
